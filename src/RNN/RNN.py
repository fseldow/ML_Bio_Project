...
hidden1_1=Dense(200, activation='relu')(hidden1)
hidden2=Dense(len(ref.h_index),activation='relu')(hidden1_1)
hidden2_1=Dense(200,activation='relu')(hidden2)
hidden2_2=Dropout(0.1)(hidden2_1)
...
model.fit(X_train, Y_train, epochs=20, verbose=1,callbacks=callback,validation_split=0.1)
