...
import conf
import src.RNN.X_Y_H as indexes
#import keras

y_index=indexes.y_index#['DXCHANGE','ADAS13','Ventricles_Norm','MMSE']
x_index=indexes.x_index#['AGE','PTGENDER','PTEDUCAT','PTETHCAT','PTRACCAT','PTMARRY','APOE4']
